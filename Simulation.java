...
public class Simulation {
	...
	private static List<Vm> createVM(int userId, int vms) {
		...
		vm[0] = new Vm(0, userId, mips, pesNumber, ram, bw, size, "201", new CloudletSchedulerSpaceShared());
		list.add(vm[0]);
		vm[1] = new Vm(1, userId, mips, pesNumber, ram, bw, size, "12", new CloudletSchedulerSpaceShared());
		list.add(vm[1]);
...
//			System.out.println(c.getId()+"---"+c.getCurrentAllocatedSize());
	...
	private static List<Cloudlet> createCloudlet(int userId, int cloudlets){
		...
		System.out.println("Printing cloudlets-----------------------");
		for(Cloudlet c : list)
	...
	private static Datacenter createDatacenter(String name){
		...
		//    create a list to store these Processing Element(PE)s before creating
		//    a Machine.
